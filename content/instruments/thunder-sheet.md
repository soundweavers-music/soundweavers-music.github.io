...
database_note: "劇場與配樂效果聲"
source_url: "https://en.wikipedia.org/wiki/Thunder_sheet"
wikidata_id: "ENWIKI-5a5a0eb1af"
---
## 介紹

# Thunder sheet（暫譯）

Thunder sheet（暫譯）（原名：Thunder sheet）是一種打擊樂器。通常透過敲擊、搖動、摩擦或刮奏產生聲音，常負責節奏與音色層次。

目前中文資料較少，因此本條目先依英文維基與 Wikidata 的可查資料整理。後續可再補充 Thunder sheet 的製作方式、代表曲目與地方流派。

## 可查證來源

- Wikipedia / Wikidata 來源：https://en.wikipedia.org/wiki/Thunder_sheet

- Wikidata ID：ENWIKI-5a5a0eb1af

## 歷史背景

Thunder sheet（暫譯）（Thunder sheet）的歷史背景可先從可查來源、樂器分類與流傳地區三個方向理解。
...
來源：https://en.wikipedia.org/wiki/Thunder_sheet
...
- **資料狀態**：承接553條目地域欄
### 讀者導覽
閱讀 Thunder Sheet 時，可以先從「金屬效果器」與「抖動／敲擊」切入，觀察它如何把材料、手勢與共鳴連在一起。
