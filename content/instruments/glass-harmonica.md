...
玻璃琴（原名：Glass harmonica）是一種鍵盤樂器。以鍵盤作為主要操作介面，演奏者透過按鍵控制發聲機構或電子聲源。

目前中文資料較少，因此本條目先依英文維基與 Wikidata 的可查資料整理。後續可再補充 Glass harmonica 的製作方式、代表曲目與地方流派。

## 可查證來源

- Wikipedia / Wikidata 來源：https://en.wikipedia.org/wiki/Glass_harmonica

- Wikidata ID：Q917571

## 歷史背景

玻璃琴（Glass harmonica）的歷史背景可先從可查來源、樂器分類與流傳地區三個方向理解。
...
來源：https://zh.wikipedia.org/wiki/%E7%8E%BB%E7%92%83%E7%90%B4
