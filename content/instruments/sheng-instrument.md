...
source_url: "https://en.wikipedia.org/wiki/Sheng_(instrument)"
wikidata_id: "ENWIKI-f7ecaaecbf"
---
## 介紹

# Sheng (instrument)（暫譯）

Sheng (instrument)（暫譯）（原名：Sheng (instrument)）是一種管樂器。主要靠氣流與管體、簧片或吹口產生聲音，音色會受吹奏方式與管身構造影響。

目前中文資料較少，因此本條目先依英文維基與 Wikidata 的可查資料整理。後續可再補充 Sheng (instrument) 的製作方式、代表曲目與地方流派。

## 可查證來源

- Wikipedia / Wikidata 來源：https://en.wikipedia.org/wiki/Sheng_(instrument)

- Wikidata ID：ENWIKI-f7ecaaecbf

## 歷史背景

Sheng (instrument)（暫譯）（Sheng (instrument)）的歷史背景可先從可查來源、樂器分類與流傳地區三個方向理解。
...
來源：https://en.wikipedia.org/wiki/Sheng_(instrument)
...
- **資料狀態**：承接553條目地域欄
### 讀者導覽
閱讀 Sheng 時，可以先從「自由簧吹奏」與「自由簧」切入，觀察它如何把材料、手勢與共鳴連在一起。
