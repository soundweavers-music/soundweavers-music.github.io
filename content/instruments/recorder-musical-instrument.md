...
source_url: "https://zh.wikipedia.org/wiki/%E7%9B%B4%E7%AC%9B"
wikidata_id: "ENWIKI-9a9013fd58"
---
## 介紹

# 直笛

直笛（原名：Recorder (musical instrument)）是一種管樂器。主要靠氣流與管體、簧片或吹口產生聲音，音色會受吹奏方式與管身構造影響。

目前中文資料較少，因此本條目先依英文維基與 Wikidata 的可查資料整理。後續可再補充 Recorder (musical instrument) 的製作方式、代表曲目與地方流派。

## 可查證來源

- Wikipedia / Wikidata 來源：https://en.wikipedia.org/wiki/Recorder_(musical_instrument)

- Wikidata ID：ENWIKI-9a9013fd58

## 歷史背景

直笛（Recorder (musical instrument)）的歷史背景可先從可查來源、樂器分類與流傳地區三個方向理解。
...
來源：https://zh.wikipedia.org/wiki/%E7%9B%B4%E7%AC%9B
...
- **資料狀態**：承接553條目地域欄
### 讀者導覽
閱讀 Recorder 時，可以先從「鼻笛與特殊吹管」與「鼻吹／特殊吹奏」切入，觀察它如何把材料、手勢與共鳴連在一起。
