...
image_spec: "玻璃杯摩擦發聲，補足材料聲音"
source_basis: "10_補充後總清單＋553條目地域欄"
database_status: "建議新增"
database_note: "玻璃杯摩擦發聲，補足材料聲音"
source_url: "https://en.wikipedia.org/wiki/Glass_harp"
wikidata_id: "ENWIKI-9b92870123"
---
## 介紹

# Glass 豎琴

Glass 豎琴（原名：Glass harp）是一種打擊樂器。通常透過敲擊、搖動、摩擦或刮奏產生聲音，常負責節奏與音色層次。

目前中文資料較少，因此本條目先依英文維基與 Wikidata 的可查資料整理。後續可再補充 Glass harp 的製作方式、代表曲目與地方流派。

## 可查證來源

- Wikipedia / Wikidata 來源：https://en.wikipedia.org/wiki/Glass_harp

- Wikidata ID：ENWIKI-9b92870123

## 歷史背景

Glass 豎琴（Glass harp）的歷史背景可先從可查來源、樂器分類與流傳地區三個方向理解。
...
來源：https://en.wikipedia.org/wiki/Glass_harp
...
- **資料狀態**：系統初稿推定，需逐篇來源核對
### 讀者導覽
閱讀 Glass Harp 時，可以先從「玻璃摩擦體鳴」與「摩擦」切入，觀察它如何把材料、手勢與共鳴連在一起。
