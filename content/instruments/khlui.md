...
image_spec: "泰國直笛，補足東南亞吹管"
source_basis: "10_補充後總清單＋553條目地域欄"
database_status: "建議新增"
database_note: "泰國直笛，補足東南亞吹管"
source_url: "https://en.wikipedia.org/wiki/Khlui"
wikidata_id: "ENWIKI-d90ea95fe6"
---
## 介紹

# Khlui（暫譯）

Khlui（暫譯）（原名：Khlui）是一種管樂器。主要靠氣流與管體、簧片或吹口產生聲音，音色會受吹奏方式與管身構造影響。

目前中文資料較少，因此本條目先依英文維基與 Wikidata 的可查資料整理。後續可再補充 Khlui 的製作方式、代表曲目與地方流派。

## 可查證來源

- Wikipedia / Wikidata 來源：https://en.wikipedia.org/wiki/Khlui

- Wikidata ID：ENWIKI-d90ea95fe6

## 歷史背景

Khlui（暫譯）（Khlui）的歷史背景可先從可查來源、樂器分類與流傳地區三個方向理解。
...
來源：https://en.wikipedia.org/wiki/Khlui
...
- **資料狀態**：系統初稿推定，需逐篇來源核對
### 讀者導覽
閱讀 Khlui 時，可以先從「東南亞直笛」與「端吹」切入，觀察它如何把材料、手勢與共鳴連在一起。
