...
source_url: "https://en.wikipedia.org/wiki/Valiha"
wikidata_id: "ENWIKI-b9d2d091e3"
---
## 介紹

# Valiha（暫譯）

Valiha（暫譯）（原名：Valiha）是一種弦樂器。主要靠弦的振動發聲，常透過撥、拉、彈、擊等方式演奏。

目前中文資料較少，因此本條目先依英文維基與 Wikidata 的可查資料整理。後續可再補充 Valiha 的製作方式、代表曲目與地方流派。

## 可查證來源

- Wikipedia / Wikidata 來源：https://en.wikipedia.org/wiki/Valiha

- Wikidata ID：ENWIKI-b9d2d091e3

## 歷史背景

Valiha（暫譯）（Valiha）的歷史背景可先從可查來源、樂器分類與流傳地區三個方向理解。
...
來源：https://en.wikipedia.org/wiki/Valiha
...
- **資料狀態**：承接553條目地域欄
### 讀者導覽
閱讀 Valiha 時，可以先從「管式／槽式齊特」與「撥弦」切入，觀察它如何把材料、手勢與共鳴連在一起。
