...
image_spec: "菲律賓穆斯林群體竹笛代表"
source_basis: "10_補充後總清單＋553條目地域欄"
database_status: "建議新增"
database_note: "菲律賓穆斯林群體竹笛代表"
source_url: "https://en.wikipedia.org/wiki/Palendag"
wikidata_id: "ENWIKI-55f581e632"
---
## 介紹

# Palendag（暫譯）

Palendag（暫譯）（原名：Palendag）是一種管樂器。主要靠氣流與管體、簧片或吹口產生聲音，音色會受吹奏方式與管身構造影響。

目前中文資料較少，因此本條目先依英文維基與 Wikidata 的可查資料整理。後續可再補充 Palendag 的製作方式、代表曲目與地方流派。

## 可查證來源

- Wikipedia / Wikidata 來源：https://en.wikipedia.org/wiki/Palendag

- Wikidata ID：ENWIKI-55f581e632

## 歷史背景

Palendag（暫譯）（Palendag）的歷史背景可先從可查來源、樂器分類與流傳地區三個方向理解。
...
來源：https://en.wikipedia.org/wiki/Palendag
...
- **資料狀態**：系統初稿推定，需逐篇來源核對
### 讀者導覽
閱讀 Palendag 時，可以先從「菲律賓竹笛」與「唇吹」切入，觀察它如何把材料、手勢與共鳴連在一起。
