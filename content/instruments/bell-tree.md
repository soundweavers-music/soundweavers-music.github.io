...
鐘 tree（原名：Bell tree）是一種打擊樂器。通常透過敲擊、搖動、摩擦或刮奏產生聲音，常負責節奏與音色層次。

目前中文資料較少，因此本條目先依英文維基與 Wikidata 的可查資料整理。後續可再補充 Bell tree 的製作方式、代表曲目與地方流派。

## 可查證來源

- Wikipedia / Wikidata 來源：https://en.wikipedia.org/wiki/Bell_tree

- Wikidata ID：ENWIKI-ed033c739c

## 歷史背景

鐘 tree（Bell tree）的歷史背景可先從可查來源、樂器分類與流傳地區三個方向理解。
...
來源：https://en.wikipedia.org/wiki/Bell_tree
