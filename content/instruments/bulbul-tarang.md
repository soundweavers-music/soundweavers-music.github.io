...
source_url: "https://en.wikipedia.org/wiki/Bulbul_tarang"
wikidata_id: "ENWIKI-db0241c499"
---
## 介紹

# Bulbul tarang（暫譯）

Bulbul tarang（暫譯）（原名：Bulbul tarang）是一種弦樂器。主要靠弦的振動發聲，常透過撥、拉、彈、擊等方式演奏。

目前中文資料較少，因此本條目先依英文維基與 Wikidata 的可查資料整理。後續可再補充 Bulbul tarang 的製作方式、代表曲目與地方流派。

## 可查證來源

- Wikipedia / Wikidata 來源：https://en.wikipedia.org/wiki/Bulbul_tarang

- Wikidata ID：ENWIKI-db0241c499

## 歷史背景

Bulbul tarang（暫譯）（Bulbul tarang）的歷史背景可先從可查來源、樂器分類與流傳地區三個方向理解。
...
來源：https://en.wikipedia.org/wiki/Bulbul_tarang
...
- **資料狀態**：承接553條目地域欄
### 讀者導覽
閱讀 Bulbul Tarang 時，可以先從「齊特琴延伸與現代變形」與「撥／擊／鍵盤」切入，觀察它如何把材料、手勢與共鳴連在一起。
