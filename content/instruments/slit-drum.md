...
source_url: "https://en.wikipedia.org/wiki/Slit_drum"
wikidata_id: "ENWIKI-4b9400e339"
---
## 介紹

# Slit 鼓

Slit 鼓（原名：Slit drum）是一種打擊樂器。通常透過敲擊、搖動、摩擦或刮奏產生聲音，常負責節奏與音色層次。

目前中文資料較少，因此本條目先依英文維基與 Wikidata 的可查資料整理。後續可再補充 Slit drum 的製作方式、代表曲目與地方流派。

## 可查證來源

- Wikipedia / Wikidata 來源：https://en.wikipedia.org/wiki/Slit_drum

- Wikidata ID：ENWIKI-4b9400e339

## 歷史背景

Slit 鼓（Slit drum）的歷史背景可先從可查來源、樂器分類與流傳地區三個方向理解。
...
來源：https://en.wikipedia.org/wiki/Slit_drum
...
- **資料狀態**：承接553條目地域欄
### 讀者導覽
閱讀 Slit Drum 時，可以先從「竹與管狀敲擊」與「敲擊／搖動」切入，觀察它如何把材料、手勢與共鳴連在一起。
