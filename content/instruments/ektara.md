...
source_url: "https://en.wikipedia.org/wiki/Ektara"
wikidata_id: "ENWIKI-860c0ffde7"
---
## 介紹

# Ektara（暫譯）

Ektara（暫譯）（原名：Ektara）是一種弦樂器。主要靠弦的振動發聲，常透過撥、拉、彈、擊等方式演奏。

目前中文資料較少，因此本條目先依英文維基與 Wikidata 的可查資料整理。後續可再補充 Ektara 的製作方式、代表曲目與地方流派。

## 可查證來源

- Wikipedia / Wikidata 來源：https://en.wikipedia.org/wiki/Ektara

- Wikidata ID：ENWIKI-860c0ffde7

## 歷史背景

Ektara（暫譯）（Ektara）的歷史背景可先從可查來源、樂器分類與流傳地區三個方向理解。
...
來源：https://en.wikipedia.org/wiki/Ektara
...
- **資料狀態**：系統初稿推定，需逐篇來源核對
### 讀者導覽
閱讀 Ektara 時，可以先從「單弦齊特」與「撥弦＋變音」切入，觀察它如何把材料、手勢與共鳴連在一起。
