...
image: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/78/Scheitholt_instrument.jpg/960px-Scheitholt_instrument.jpg"
source_url: "https://en.wikipedia.org/wiki/Scheitholt"
wikidata_id: "Q2624504"
---
## 介紹

# Scheitholt（暫譯）

Scheitholt（暫譯）（原名：Scheitholt）是一種弦樂器。主要靠弦的振動發聲，常透過撥、拉、彈、擊等方式演奏。
...
- Wikipedia / Wikidata 來源：https://en.wikipedia.org/wiki/Scheitholt

- Wikidata ID：Q2624504

## 歷史背景

Scheitholt（暫譯）（Scheitholt）的歷史背景可先從可查來源、樂器分類與流傳地區三個方向理解。
...
來源：https://en.wikipedia.org/wiki/Scheitholt
...
- **資料狀態**：承接553條目地域欄
### 讀者導覽
閱讀 Scheitholt 時，可以先從「齊特琴延伸與現代變形」與「撥／擊／鍵盤」切入，觀察它如何把材料、手勢與共鳴連在一起。
