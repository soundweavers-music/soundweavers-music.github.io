...
image_spec: "旁遮普民俗與 Bhangra 音色代表"
source_basis: "10_補充後總清單＋553條目地域欄"
database_status: "建議新增"
database_note: "旁遮普民俗與 Bhangra 音色代表"
source_url: "https://en.wikipedia.org/wiki/Tumbi"
wikidata_id: "ENWIKI-20d2c8ebfe"
---
## 介紹

# Tumbi（暫譯）

Tumbi（暫譯）（原名：Tumbi）是一種弦樂器。主要靠弦的振動發聲，常透過撥、拉、彈、擊等方式演奏。

目前中文資料較少，因此本條目先依英文維基與 Wikidata 的可查資料整理。後續可再補充 Tumbi 的製作方式、代表曲目與地方流派。

## 可查證來源

- Wikipedia / Wikidata 來源：https://en.wikipedia.org/wiki/Tumbi

- Wikidata ID：ENWIKI-20d2c8ebfe

## 歷史背景

Tumbi（暫譯）（Tumbi）的歷史背景可先從可查來源、樂器分類與流傳地區三個方向理解。
...
來源：https://en.wikipedia.org/wiki/Tumbi
...
- **資料狀態**：系統初稿推定，需逐篇來源核對
### 讀者導覽
閱讀 Tumbi 時，可以先從「單弦撥弦」與「撥弦」切入，觀察它如何把材料、手勢與共鳴連在一起。
