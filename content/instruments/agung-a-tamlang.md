...
country: "菲律賓"
era: "傳統／年代待考"
image: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3d/Agung_a_Tamlang.jpg/960px-Agung_a_Tamlang.jpg"
listen_link: ""
source_url: "https://en.wikipedia.org/wiki/Agung_a_tamlang"
wikidata_id: "Q4694587"
---
## 介紹

# Agung a tamlang（暫譯）

Agung a tamlang（暫譯）（原名：Agung a tamlang）是一種打擊樂器。通常透過敲擊、搖動、摩擦或刮奏產生聲音，常負責節奏與音色層次。
...
- Wikipedia / Wikidata 來源：https://en.wikipedia.org/wiki/Agung_a_tamlang

- Wikidata ID：Q4694587

## 歷史背景

Agung a tamlang（暫譯）（Agung a tamlang）的歷史背景可先從可查來源、樂器分類與流傳地區三個方向理解。
...
來源：https://en.wikipedia.org/wiki/Agung_a_tamlang
