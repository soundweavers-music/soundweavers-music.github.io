...
image_spec: "葡萄牙 Fado 代表性撥弦"
source_basis: "10_補充後總清單＋553條目地域欄"
database_status: "建議新增"
database_note: "葡萄牙 Fado 代表性撥弦"
image: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/01/2_Portuguese_guitars.jpg/960px-2_Portuguese_guitars.jpg"
source_url: "https://en.wikipedia.org/wiki/Portuguese_guitar"
wikidata_id: "Q585289"
---
## 介紹
...
Portuguese 吉他（原名：Portuguese guitar）是一種弦樂器。主要靠弦的振動發聲，常透過撥、拉、彈、擊等方式演奏。

材料與構造是它音色的重要線索；不同材質會讓聲音呈現更明亮、厚實或有共鳴感的差異。

## 可查證來源

- Wikipedia / Wikidata 來源：https://en.wikipedia.org/wiki/Portuguese_guitar

- Wikidata ID：Q585289

## 歷史背景

Portuguese 吉他（Portuguese guitar）的歷史背景可先從可查來源、樂器分類與流傳地區三個方向理解。
...
來源：https://en.wikipedia.org/wiki/Portuguese_guitar
...
- **資料狀態**：承接553條目地域欄
### 讀者導覽
閱讀 Portuguese Guitar 時，可以先從「梨形魯特琴」與「撥弦」切入，觀察它如何把材料、手勢與共鳴連在一起。
