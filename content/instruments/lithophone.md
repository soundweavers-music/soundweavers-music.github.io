...
source_url: "https://en.wikipedia.org/wiki/Lithophone"
wikidata_id: "ENWIKI-06f5e11ede"
---
## 介紹

# Lithophone（暫譯）

Lithophone（暫譯）（原名：Lithophone）是一種打擊樂器。通常透過敲擊、搖動、摩擦或刮奏產生聲音，常負責節奏與音色層次。

目前中文資料較少，因此本條目先依英文維基與 Wikidata 的可查資料整理。後續可再補充 Lithophone 的製作方式、代表曲目與地方流派。

## 可查證來源

- Wikipedia / Wikidata 來源：https://en.wikipedia.org/wiki/Lithophone

- Wikidata ID：ENWIKI-06f5e11ede

## 歷史背景

Lithophone（暫譯）（Lithophone）的歷史背景可先從可查來源、樂器分類與流傳地區三個方向理解。
...
來源：https://en.wikipedia.org/wiki/Lithophone
...
- **資料狀態**：承接553條目地域欄
### 讀者導覽
閱讀 Lithophone 時，可以先從「石琴與陶石聲響」與「槌擊」切入，觀察它如何把材料、手勢與共鳴連在一起。
