...
source_url: "https://zh.wikipedia.org/wiki/%E5%AE%9A%E9%9F%B3%E9%BC%93"
wikidata_id: "ENWIKI-8f7f02ac90"
---
## 介紹

# 定音鼓

定音鼓（原名：Timpani）是一種打擊樂器。通常透過敲擊、搖動、摩擦或刮奏產生聲音，常負責節奏與音色層次。

目前中文資料較少，因此本條目先依英文維基與 Wikidata 的可查資料整理。後續可再補充 Timpani 的製作方式、代表曲目與地方流派。

## 可查證來源

- Wikipedia / Wikidata 來源：https://en.wikipedia.org/wiki/Timpani

- Wikidata ID：ENWIKI-8f7f02ac90

## 歷史背景

定音鼓（Timpani）的歷史背景可先從可查來源、樂器分類與流傳地區三個方向理解。
...
來源：https://zh.wikipedia.org/wiki/%E5%AE%9A%E9%9F%B3%E9%BC%93
...
- **資料狀態**：承接553條目地域欄
### 讀者導覽
閱讀 Timpani 時，可以先從「鍋鼓與定音鼓」與「槌擊／調音」切入，觀察它如何把材料、手勢與共鳴連在一起。
